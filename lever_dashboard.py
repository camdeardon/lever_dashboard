        ...
        children=[
            dbc.Col(
                children=[
                    html.Div(
                        ...
                        #Salary Distributions
                            html.Div(
                                [html.H4('Salary distribution', style=
                ...
                children=[
                    html.Div(
                        children=[
                            html.H4('Top 5 highest vacancy jobs by Hourly vs Annual salaries', 
                            style={'margin-right': '2em', 'font-family': 'Helvetica'}
                                ),
                            dcc.RadioItems(
                                id='hourly_vs_annual',
                                options=[
                                {'label': 'Hourly', 'value': 'OPT1'},
                                {'label': 'Annual', 'value':'OPT2'}
                            ], value='OPT2',
...
def update_graph(report_type):
    ...
    if report_type == 'OPT1':
        ...
        df, 
            ...
            color_discrete_sequence=px.colors.sequential.Bluyl,hole=.4)
...
def update_salary_visuals(hourly_vs_annual):
    ...
    title='Jobs with most vacancies:',
